namespace OOP
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //show Abstraction what it can do
            ...
            //Interface dosen't contain constructor
            ...
            //inherit from multiple abstract classes NO
    ...
    new CompletedShipment(
        ...
        public class InternationalShipment : shipment
        {
            ...
            public InternationalShipment(
                ...
                string description,
                decimal weight,
                decimal deliveryFee,DeliveryAddress destination,string destinationCountry,decimal customsFee)  : base(trackingCode, description, weight, deliveryFee, destination)
            {
